...
local color_picker= "hyprpicker -a --format=rgb"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgb(255, 255, 255)"}, angle = 45 },
...
hl.bind(mainMod .. " + K", hl.dsp.exec_cmd("cliphist list | rofi -dmenu -display-columns 2 | cliphist decode | wl-copy"))
